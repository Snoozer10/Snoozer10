with open("README.md", encoding="utf-8") as f:
    md = f.read()
assert "specialization: \"Full-Stack Cloud Architecture & Autonomous AI Agent Systems\"" in md or "specialization: \"Full-Stack Development & Enterprise Cloud Architecture\"" in md
